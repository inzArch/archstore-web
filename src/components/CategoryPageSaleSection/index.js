...
const CategoryPageSaleSection = () => {
	return (
		<div className='category-page-sale-section'>
			...
			<EmblaCarousel>
				{onSale.map(
					({ item, name, detail, oldprice, newprice, category }, i) => (
						<div className='category-page-sale-section-card'>
							<div className='category-page-sale-section-card-upper'>
								...
								<div className='category-page-sale-section-discount'>
									{' '}
									-10%{' '}
								</div>
								<div className='category-page-sale-section-bimcad'>
									<img src={Cube} />
								</div>
								...
								<div
									className='category-page-sale-section-details'
								...
								>
									...
									>
										...
										<p
											...
											style={{ color: '#ff6363', fontWeight: '600' }}
										>
											{newprice}
										</p>
									</div>
